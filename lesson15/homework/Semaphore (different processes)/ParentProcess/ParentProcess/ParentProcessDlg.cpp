...
//{2525FD5F-12E6-47c0-838A-7C5CA1EBD169}
void ParentProcessDlg::Cls_OnCommand(HWND hwnd, int id, HWND hwndCtl, UINT codeNotify)
{
	if(IDC_BUTTON1 == id)
	{
		//HANDLE hEvent = CreateEvent(NULL, FALSE /* ручной сброс события */, FALSE /* несигнальное состояние */, TEXT("{2525FD5F-12E6-47c0-838A-7C5CA1EBD169}"));
